...
const CloseSidebarButton = ({ onClose }: Props) => {
  return (
    <button
      ...
      className={
        'aspect-square p-2 rounded-md hover:bg-pink-100 dark:hover:bg-gray-600 active:bg-pink-100 dark:active:bg-gray-600 active:scale-97 transition duration-300'
      }
    >
      <svg
        aria-hidden={true}
...
export default memo(CloseSidebarButton)
